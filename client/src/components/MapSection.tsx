...
export default function MapSection() {
  ...
  // La carte s'affiche d'emblée — arbitrage d'Anthony du 26/09/2026, qui revient
  // sur la porte de consentement posée la veille.
  //
  // Ce que ça implique, mesuré sur la production le 25/09 : l'iframe déclenche
  // 14 requêtes vers maps.googleapis.com, maps.gstatic.com et www.google.com dès
  // l'ouverture de la page, avant toute action du visiteur. L'adresse IP part donc
  // chez Google sans que personne ne l'ait demandé. Aucun cookie n'était posé au
  // relevé, mais c'est Chrome qui bloque les cookies tiers, pas le site qui est
  // sobre : un autre navigateur peut donner un autre résultat.
  //
  // Conséquence à ne pas perdre de vue : la section « Cookies et traceurs » de la
  // politique de confidentialité ne peut plus affirmer que rien ne part sans
  // action du visiteur. Elle a été reformulée en conséquence.
